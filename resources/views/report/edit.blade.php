<x-app-layout>
    <div class="bg-bacK dark:bg-gray-700">
        <section class="flex items-center 
                justify-center">
            <form class="max-w-md mx-auto p-8 text-black dark:text-white bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-secondary/50 flex flex-col gap-6" action="{{route('report.update', $report->id)}}" method="POST">
                @csrf
                @method('put')
